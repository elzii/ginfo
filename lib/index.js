...
if ( fs.existsSync( git.dir ) ) {
  ...
  if ( remotes ) {
    remotes.forEach( function (remote, i) {
      ...
      console.log(i+1)
      console.log( chalk.bgWhite.black(' remote '), chalk.white((remote.match(/(\")(.*?)(\")/g)[0])) )
      console.log( chalk.bgGreen.black('  ssh   ' ), chalk.green( git_url ) )
      console.log( chalk.bgCyan.black('  http  '), chalk.cyan( http_url ) )
